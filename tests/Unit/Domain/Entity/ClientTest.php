...
class ClientTest extends TestCase
{
     ...
     * @throws AssertionFailedException|\Exception
     */
    public function it_should_return_only_available_points()
    {
        $uuid   = Uuid::uuid4();
        $name   = ClientName::fromStr('test client');
        $client = Client::create($uuid, $name);
     ...
     * @throws AssertionFailedException|\Exception
     */
    public function it_should_return_partial_quantity_of_available_points()
    {
        $uuid   = Uuid::uuid4();
        $name   = ClientName::fromStr('test client');
        $client = Client::create($uuid, $name);
     ...
     * @throws AssertionFailedException|\Exception
     */
    public function it_should_launch_exception_when_require_invalid_quantity_points()
    {
